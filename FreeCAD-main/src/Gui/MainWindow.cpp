...
#include "ComboView.h"
// LinuxCAD shell - installed at the end of MainWindow construction.
#include "LinuxCAD/LinuxCadShell.h"
#include "Command.h"
    ...
    : QMainWindow(parent, f /*WDestructiveClose*/)
{
    ...
    // Install the LinuxCAD shell (top bar, project dock, welcome screen,
    // theme, command palette). Idempotent; replaces FreeCAD's classic chrome.
    Gui::LinuxCAD::install(this);
}
