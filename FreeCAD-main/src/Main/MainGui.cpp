...
int main(int argc, char** argv)
{
    ...
    // LinuxCAD branding: this fork keeps FreeCAD's engine but ships under the
    // LinuxCAD product name. ExeVendor is kept as "FreeCAD" so existing user
    // settings, recent file paths, and FreeCAD addons continue to work.
    App::Application::Config()["ExeName"] = "LinuxCAD";
    App::Application::Config()["ExeVendor"] = "FreeCAD";
    App::Application::Config()["AppDataSkipVendor"] = "true";
    App::Application::Config()["MaintainerUrl"] = "https://github.com/githubgoog/LinuxCAD";
